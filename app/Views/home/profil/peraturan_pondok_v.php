          ...
          <div class="row mt-n5">
            <div class="card w-auto ">
              <div class="col-md-12 d-flex align-items-center p-3">
                ...
                <div class="ms-4">
                  <h4 class="fw-bold ">Peraturan Pondok</h4>
                  <p class="text-dark">Peraturan Pondok <?= $profilApp['nama_pondok'] ?></p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-md-12 col-lg-4 ">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row border-top p-3">
              <a href="<?= base_url() . 'peraturan-pondok' ?>" class="text-decoration-none link-dark">Peraturan Pondok</a>
            </div>
          </div>
        </div>
      </div>
