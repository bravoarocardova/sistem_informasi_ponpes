                ...
                <tbody>
                  <?php foreach ($siswa as $r) : ?>
                    <tr>
                      ...
                      <td>
                        <form action="<?= base_url() ?>ustadz/nilai/<?= $kelas['id_kelas'] ?>/mapel/<?= $mapel['kd_mapel'] ?>" method="post">
                          <?= csrf_field() ?>
                          <input type="hidden" name="_method" value="PUT">
                          <input type="hidden" name="id_nilai" value="<?= $r['id_nilai'] ?>">
                          <input type="hidden" name="id_data_kelas" value="<?= $r['id_data_kelas'] ?>">
                          <input type="number" name="nilai" value="<?= $r['nilai'] ?>">
