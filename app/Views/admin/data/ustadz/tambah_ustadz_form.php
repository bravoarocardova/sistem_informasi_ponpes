                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control <?= validation_show_error('kd_ustadz') ? 'is-invalid' : '' ?>" id="kd_ustadz" name="kd_ustadz" placeholder="Kode Ustadz" value="<?= old('kd_ustadz') ?>">
                    ...
                    <div class="mb-3">
                      ...
                      <textarea name="alamat" id="inputalamat" cols="30" rows="3" class="form-control <?= validation_show_error('alamat') ? 'is-invalid' : '' ?>" placeholder="Alamat"><?= old('alamat') ?></textarea>
                      <div class="invalid-feedback">
