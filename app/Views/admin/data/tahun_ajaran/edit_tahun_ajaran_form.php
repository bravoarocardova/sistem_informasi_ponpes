                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control <?= validation_show_error('tahun_ajaran') ? 'is-invalid' : '' ?>" id="tahun_ajaran" name="tahun_ajaran" placeholder="Tahun Ajaran" value="<?= old('tahun_ajaran', $tahun_ajaran['tahun_ajaran']) ?>">
