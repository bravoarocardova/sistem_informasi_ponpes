...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Tambah Slideshow</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            ...
            <div class="card-body">
              <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="mb-3">
                      <img alt="" src="" class="rounded img-responsive mt-2" width="214" height="128" id="img-slideshow-upload">
                      <div class="mt-2">
                        <label for="slideshow">
                    ...
                    <div class="mb-3">
                      ...
                      <select name="align" id="align" class="form-control <?= validation_show_error('align') ? 'is-invalid' : '' ?>">
                        ...
                        <option value="start" <?= (old('align') == 'start' ? 'selected' : '') ?>>Start</option>
                        <option value="center" <?= (old('align') == 'center' ? 'selected' : '') ?>>Center</option>
                        <option value="end" <?= (old('align') == 'end' ? 'selected' : '') ?>>End</option>
                      </select>
                      <div class="invalid-feedback">
