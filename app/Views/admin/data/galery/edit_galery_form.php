            ...
            <div class="card-body">
              <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="mb-3">
                      <img alt="" src="<?= base_url() . 'img/galery/' . $galery['file'] ?>" class="rounded img-responsive mt-2" width="128" height="128" id="img-file-upload">
                      <div class="mt-2">
                        <label for="file">
                    ...
                    <div class="mb-3">
                      ...
                      <textarea name="caption" id="caption" cols="30" rows="2" placeholder="Caption" class="form-control  <?= validation_show_error('caption') ? 'is-invalid' : '' ?>"><?= old('caption', $galery['caption']) ?></textarea>
                      <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                      ...
                      <select name="tipe" id="tipe" class="form-control <?= validation_show_error('tipe') ? 'is-invalid' : '' ?>">
                        ...
                        <option value="foto" <?= (old('tipe', $galery['tipe']) == 'foto' ? 'selected' : '') ?>>Foto</option>
                        <option value="video" <?= (old('tipe', $galery['tipe']) == 'video' ? 'selected' : '') ?>>Video</option>
                      </select>
                      <div class="invalid-feedback">
