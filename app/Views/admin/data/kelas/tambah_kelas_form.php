                ...
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control <?= validation_show_error('wali_kelas') ? 'is-invalid' : '' ?>" id="wali_kelas" name="wali_kelas" placeholder="Wali kelas" value="<?= old('wali_kelas') ?>">
                      <div class="invalid-feedback">
