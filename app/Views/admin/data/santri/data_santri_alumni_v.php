...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Data Santri Alumni</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Data</a></li>
            <li class="breadcrumb-item active">Santri Alumni</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped ">
                ...
                <tbody>
                  <?php foreach ($santri_alumni as $s) : ?>
                    <tr>
                      <td><?= $s['nis'] ?></td>
                      <td><?= $s['nama_santri'] ?></td>
                      <td><?= $s['jk'] ?></td>
                      ...
                      <td><?= $s['updated_at'] ?></td>
                      <td>
                        <form action="<?= base_url() ?>admin/data/alumni/kembalikan/<?= $s['nis'] ?>" method="post" class="d-inline">
                          <?= csrf_field() ?>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Tambah Santri Alumni</h4>
          ...
          <tbody>
            <?php foreach ($santri as $s) : ?>
              <tr>
                ...
                <td><?= $s['updated_at'] ?></td>
                <td>
                  <form action="<?= base_url() ?>admin/data/alumni/tambah/<?= $s['nis'] ?>" method="post" class="d-inline">
                    <?= csrf_field() ?>
                    <input type="hidden" name="_method" value="PUT">
