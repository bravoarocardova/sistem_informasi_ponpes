...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Tambah Mapel Kelas <?= $kelas['nama_kelas'] ?> ( <?= $kelas['tahun_ajaran'] ?> - <?= $kelas['semester'] ?> )</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                    ...
                    <div class="mb-3">
                      ...
                      <select name="kd_mapel" id="kd_mapel" class="form-control <?= validation_show_error('kd_mapel') ? 'is-invalid' : '' ?>">
                        ...
                        <?php foreach ($mapel as $t) : ?>
                          <option value="<?= $t['kd_mapel'] ?>" <?= (old('kd_mapel') ==  $t['kd_mapel'] ? 'selected' : '') ?>><?= $t['nama_mapel'] ?> ( <?= $t['kd_mapel'] ?> )</option>
                        <?php endforeach ?>
                      </select>
                    ...
                    <div class="mb-3">
                      ...
                      <select name="kd_ustadz" id="kd_ustadz" class="form-control <?= validation_show_error('kd_ustadz') ? 'is-invalid' : '' ?>">
                        ...
                        <?php foreach ($ustadz as $t) : ?>
                          <option value="<?= $t['kd_ustadz'] ?>" <?= (old('kd_ustadz') ==  $t['kd_ustadz'] ? 'selected' : '') ?>><?= $t['nama_ustadz'] ?> ( <?= $t['kd_ustadz'] ?> )</option>
                        <?php endforeach ?>
                      </select>
                      <div class="invalid-feedback">
