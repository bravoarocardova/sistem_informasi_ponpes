                ...
                <tbody>
                  <?php foreach ($kelas_siswa as $u) : ?>
                    <tr>
                      ...
                      <td><?= $u['jk'] ?></td>
                      <td>
                        <a href="<?= base_url() ?>admin/data/kelas/nilai/<?= $u['id_data_kelas'] ?>" class="btn btn-success"><i class="fas fa-eye"></i> Lihat Nilai</a>
                      </td>
                      <td><?= $u['created_at'] ?></td>
                      <td><?= $u['updated_at'] ?></td>
                      <td>
                        <form action="<?= base_url() ?>admin/data/kelas/<?= $u['id_kelas'] ?>/siswa/hapus/<?= $u['id_data_kelas'] ?>" method="post" class="d-inline">
                          <?= csrf_field() ?>
          ...
          <tbody>
            <?php foreach ($santri as $s) : ?>
              <tr>
                ...
                <td><?= $s['updated_at'] ?></td>
                <td>
                  <form action="<?= base_url() ?>admin/data/kelas/<?= $kelas['id_kelas'] ?>/siswa/tambah/<?= $s['nis'] ?>" method="post" class="d-inline">
                    <?= csrf_field() ?>
