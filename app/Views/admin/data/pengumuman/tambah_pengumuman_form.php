                  ...
                  <div class="col-md-8">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="form-check ">
                        <input type="radio" class="form-check-input <?= validation_show_error('kategori') ? 'is-invalid' : '' ?>" id="kategori2" name="kategori" value="berita" oninvalid="this.setCustomValidity('Pilih Salah Satu')" <?= (old('kategori') == 'berita' ? 'checked' : '') ?> checked>
                        <label class="form-check-label" for="kategori2">Berita</label>
                      </div>
                      <div class="form-check mb-3">
                        <input type="radio" class="form-check-input <?= validation_show_error('kategori') ? 'is-invalid' : '' ?>" id="kategori3" name="kategori" value="kelulusan" oninvalid="this.setCustomValidity('Pilih Salah Satu')" <?= (old('kategori') == 'kelulusan' ? 'checked' : '') ?>>
